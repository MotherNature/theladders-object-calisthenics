...
describe Jobseeker do
  ...
  describe "Apply to Job" do
    it "should be able to apply to an ATS Job Posting without a resume" do
      ...
      @jobapplicationrecordservice.apply_jobapplication_to_posting(jobapplication: jobapplication, posting: @ats_job_posting)
      
      @jobapplicationrecordservice.jobapplications_submitted_for_posting(@ats_job_posting).should include jobapplication
    end
    ...
    it "should not be able to apply to a JReq Job Posting without a resume" do
      ...
      expect {
        @jobapplicationrecordservice.apply_jobapplication_to_posting(jobapplication: jobapplication, posting: @jreq_job_posting)
      }.to raise_error(IncompatibleJobApplicationError)

      @jobapplicationrecordservice.jobapplications_submitted_for_posting(@jreq_job_posting).should_not include jobapplication
    end
    ...
    it "should be able to apply to a JReq Job Posting with a resume" do
      ...
      @jobapplicationrecordservice.jobapplications_submitted_for_posting(@jreq_job_posting).should include jobapplication
    end
    ...
    it "should be able to apply to different Jobs Posting with different Resumes" do
      ...
      @jobapplicationrecordservice.apply_jobapplication_to_posting(jobapplication: jobapplication1, posting: @ats_job_posting)
      @jobapplicationrecordservice.apply_jobapplication_to_posting(jobapplication: jobapplication2, posting: @jreq_job_posting)
      
      @jobapplicationrecordservice.jobapplications_submitted_for_posting(@jreq_job_posting).should include jobapplication1
      @jobapplicationrecordservice.jobapplications_submitted_for_posting(@jreq_job_posting).should include jobapplication2
